...
children.push(
  new Paragraph({ children: [new PageBreak()] }),
  C.h2('A-2. 실시간 대시보드'),
  C.p('오늘의 주문 상황을 한눈에 봅니다. 화면은 실시간으로 반영되며, 연결 상태에 따라 최대 30초 내 자동으로 갱신됩니다.'),
...
// ───────── D. FAQ ─────────
const faq = [
  ['거래처가 발주를 넣었는데 제 화면에 안 보여요.', '화면은 실시간으로 반영되며, 연결 상태에 따라 최대 30초 내 자동으로 갱신됩니다. 바로 확인하시려면 우측 상단 새로고침 버튼을 눌러 주세요. 그래도 안 보이면 인터넷 연결과 로그인 상태를 확인해 주세요.'],
