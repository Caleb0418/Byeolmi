...
> ⚠️ **현행화 안내 (2026-06): 구매자 페르소나(박민지)의 핵심 가정이 폐기되었습니다.**
> - '실시간 공구 단가 투명성·게이지 확인' 니즈는 **잘못된 가정**으로 판단되어 제외되었습니다.
> - 별미집은 공동구매 단가 변동 서비스가 아니라 **B2B 도매 발주+승인+정산** 도구입니다.
> - 공급자(김성식) 페르소나의 '마감 통보' 페인포인트도 '상시 접수+승인' 모델로 대체되었습니다.
