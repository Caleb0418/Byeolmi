...
> ⚠️ **현행화 안내 (2026-06): 일부 흐름이 폐기되었습니다.**
> - 공급자 흐름의 **'17:00 마감 → 자동 단가 확정'은 미구현/폐기** — 실제로는 '상시 접수 + 발주 승인' 모델입니다.
> - 구매자 흐름의 **'실시간 공구 현황판/게이지 확인' 분기는 제외**되었습니다 (잘못된 페르소나 가정).
> - 정본은 구현(`index.html`·`client.html`·`app.js`)입니다.
